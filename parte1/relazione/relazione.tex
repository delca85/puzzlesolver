...
Per esempio, lo stato finale desiderato per i quattro pezzi del puzzle $2\times2$ ``Ciao'' \`e quello in figura.
...
L'algoritmo \`e stato scelto poich\`e BFS \`e dimostrato essere ottimale in termini di complessit\`a e perch\`e appoggiandosi su una coda appare ingenuamente pi\`u semplice da parallelizzare - come suggerito opzionalmente al punto 5. delle specifiche di progetto.
